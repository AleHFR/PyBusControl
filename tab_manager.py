...
def novo_projeto(root, projeto):
    ...
    ttk.Button(barra_ferramentas, text='Inserir Widget',command=lambda e:wm.adicionar_widget(e.x, e.y, canvas, projeto)).pack(side='left', padx=5, pady=2)
    ttk.Button(barra_ferramentas, text='Configurar Aba',command=lambda:alterar_tamanho_canvas(canvas, notebook, projeto)).pack(side='left', padx=5, pady=2)
